...
def forecast(model, last_values, n_years=5):
    ...
    for _ in range(n_years):
        ...
        # Mettre à jour last_values pour la prochaine prévision
        last_values = last_values.copy()
        last_values.iloc[-1, 1:] = forecast_value.iloc[-1]  # Mettre à jour uniquement les variables dépendantes
        last_values = last_values.shift(1)  # Décaler pour la prochaine prévision
